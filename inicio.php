...
<body>
		...
		<div class="row">
			<div class="col-md-4">
				<div class="panel panel-default">
					...
					<div style="background-color: #D1B96B;">
						<center><h3><b><i class="fas fa-dollar-sign"></i> imagen</b></h3></center>
					</div>
					<div style="background-color: #C4C7C6 ;">
						<br>
						descripcion
					</div>
	...
	<!-- SECCION PIE DE PÁGINA -->
        <footer class="pie-de-pagina text-center text-md-right bg-dark text-white">
            <div class="container">
                <p class="m-0 py-2" align="center">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Copyright © 2021. Todos los derechos reservados.</p>
            </div>
        </footer>
